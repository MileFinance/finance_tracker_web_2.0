    ...
    <div className="w-full flex-1 overflow-y-auto rounded-3xl border border-[#16162a] bg-[#04040a] p-3 sm:p-5">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4">
        ...
        <section className="grid gap-4 lg:grid-cols-[280px_1fr]">
          <article className="rounded-2xl border border-[#1e1e35] bg-[#07070e] p-5">
            <div className="mx-auto grid h-24 w-24 place-items-center rounded-full border border-[#252545] bg-[#04040a] text-3xl font-bold text-white">
              PA
            </div>
            ...
            <div className="mt-5 space-y-2">
              <p className="rounded-xl border border-[#252545] bg-[#04040a] px-3 py-2 text-sm text-neutral-300">Plan: Pro</p>
              <p className="rounded-xl border border-[#252545] bg-[#04040a] px-3 py-2 text-sm text-neutral-300">Region: Spain</p>
              <p className="rounded-xl border border-[#252545] bg-[#04040a] px-3 py-2 text-sm text-neutral-300">Timezone: Europe/Madrid</p>
            </div>
          </article>
          ...
          <div className="space-y-4">
            ...
            <section className="rounded-2xl border border-[#1e1e35] bg-[#07070e] p-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <label className="flex flex-col gap-1 text-sm text-neutral-300">
                  Language
                  <select className="rounded-xl border border-[#252545] bg-[#04040a] px-3 py-2 text-white" defaultValue="en">
                ...
                <label className="flex flex-col gap-1 text-sm text-neutral-300">
                  Default Currency
                  <select className="rounded-xl border border-[#252545] bg-[#04040a] px-3 py-2 text-white" defaultValue="EUR">
